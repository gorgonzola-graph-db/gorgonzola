...
gorgonzola_benchmark_tool = os.path.join(
    base_dir, '..', 'build', 'release', 'tools', 'benchmark', 'gorgonzola_benchmark')
...
if __name__ == '__main__':
    ...
    is_success = run_gorgonzola(serialized_graph_path)
