...
file(WRITE ${ROOT_DIR}/modules/third_party/antlr4_cypher/cypher_lexer.cpp "${LexerReplacedContent}")
...
file(WRITE ${ROOT_DIR}/modules/third_party/antlr4_cypher/cypher_parser.cpp "${ParserReplacedContent}")

# Move headers.
file(RENAME generated/CypherParser.h ${ROOT_DIR}/modules/third_party/antlr4_cypher/include/cypher_parser.h)
file(RENAME generated/CypherLexer.h ${ROOT_DIR}/modules/third_party/antlr4_cypher/include/cypher_lexer.h)
