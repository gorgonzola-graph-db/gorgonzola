PYPI_URL = "https://pypi.org/pypi/gorgonzola/json"
CMAKE_KEYWORD = "project(Gorgonzola VERSION "
CMAKE_SUFFIX = " LANGUAGES CXX C)\n"
EXTENSION_KEYWORD = 'add_definitions(-DGORGONZOLA_EXTENSION_VERSION="'
EXTENSION_SUFFIX = '")\n'
...
def main():
    ...
    sys.stdout.flush()
    os.system("git config user.email ci@gorgonzoladb.com")
    os.system("git config user.name \"Gorgonzola CI\"")
