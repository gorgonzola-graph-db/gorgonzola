...
# Example scripts/export-dbs.py build/debug/tools/shell/gorgonzola dataset.
def main():
    parser = argparse.ArgumentParser(
        description="Export DBs with GORGONZOLA shell and dataset paths"
    )

    parser.add_argument(
        "--executable", required=True, help="Path to the GORGONZOLA shell executable"
    )
    parser.add_argument(
