...
START_POINT = MAIN_HEADER_PATH / "gorgonzola.h"
JSON_HEADER_PATH = (SCRIPT_DIR / "../modules/third_party/nlohmann_json/json_fwd.hpp").resolve()
ALP_HEADERS_PATH = (SCRIPT_DIR / "../modules/third_party/alp/include").resolve()
OUTPUT_PATH = "gorgonzola.hpp"
