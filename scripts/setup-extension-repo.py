...
def extract_extension_version() -> str:
    import re
    pattern = r'-DGORGONZOLA_EXTENSION_VERSION=(["\'])(.*?)\1'
    with open('./CMakeLists.txt', 'r') as f:
        for line in f:
            ...
            if match:
                ...
                return version
    raise Exception("Failed to infer GORGONZOLA extension version from CMAKE file.")
...
if get_os() != "win":
    ...
    if get_os() == "osx":
        ...
        file_name += '.so'
    official_repo = f"https://extension.gorgonzoladb.com/{gorgonzola_version}/{arch_version}/common/{file_name}"
