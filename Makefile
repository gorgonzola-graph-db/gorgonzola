...
ifdef PAGE_SIZE_LOG2
	CMAKE_FLAGS += -DGORGONZOLA_PAGE_SIZE_LOG2=$(PAGE_SIZE_LOG2)
endif

ifdef DEFAULT_REL_STORAGE_DIRECTION
	CMAKE_FLAGS += -DGORGONZOLA_DEFAULT_REL_STORAGE_DIRECTION=$(DEFAULT_REL_STORAGE_DIRECTION)
endif

ifdef VECTOR_CAPACITY_LOG2
	CMAKE_FLAGS += -DGORGONZOLA_VECTOR_CAPACITY_LOG2=$(VECTOR_CAPACITY_LOG2)
endif

ifdef NODE_GROUP_SIZE_LOG2
	CMAKE_FLAGS += -DGORGONZOLA_NODE_GROUP_SIZE_LOG2=$(NODE_GROUP_SIZE_LOG2)
endif

ifdef MAX_SEGMENT_SIZE_LOG2
	CMAKE_FLAGS += -DGORGONZOLA_MAX_SEGMENT_SIZE_LOG2=$(MAX_SEGMENT_SIZE_LOG2)
endif
...
java_native_header:
	cmake --build build/$(call get-build-path,Release) --target gorgonzola_java
