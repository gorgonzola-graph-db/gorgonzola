...
using namespace gorgonzola_parquet::format;
...
std::unique_ptr<ColumnWriter> ColumnWriter::createWriterRecursive(
    std::vector<gorgonzola_parquet::format::SchemaElement>& schemas, ParquetWriter& writer,
    ...
    case LogicalTypeID::STRUCT: {
        ...
        gorgonzola_parquet::format::SchemaElement schema_element;
    ...
    case LogicalTypeID::LIST: {
        ...
        gorgonzola_parquet::format::SchemaElement optionalElem;
        ...
        gorgonzola_parquet::format::SchemaElement repeatedElem;
    ...
    case LogicalTypeID::MAP: {
        ...
        // 	}
        // }
        gorgonzola_parquet::format::SchemaElement topElement;
        ...
        // key_value element
        gorgonzola_parquet::format::SchemaElement kv_element;
...
void ColumnWriter::compressPage(common::BufferWriter& bufferedSerializer, size_t& compressedSize,
    ...
    case CompressionCodec::ZSTD: {
        ...
        compressedBuf = std::unique_ptr<uint8_t[]>(new uint8_t[compressedSize]);
        compressedSize = gorgonzola_zstd::ZSTD_compress((void*)compressedBuf.get(), compressedSize,
    ...
    case CompressionCodec::LZ4_RAW: {
        compressedSize = gorgonzola_lz4::LZ4_compressBound(bufferedSerializer.getSize());
        compressedBuf = std::unique_ptr<uint8_t[]>(new uint8_t[compressedSize]);
        compressedSize = gorgonzola_lz4::LZ4_compress_default(
            reinterpret_cast<const char*>(bufferedSerializer.getBlobData()),
