...
template GORGONZOLA_API void ValueVector::setValue<nodeID_t>(uint32_t pos, nodeID_t val);
template GORGONZOLA_API void ValueVector::setValue<bool>(uint32_t pos, bool val);
template GORGONZOLA_API void ValueVector::setValue<int64_t>(uint32_t pos, int64_t val);
template GORGONZOLA_API void ValueVector::setValue<int32_t>(uint32_t pos, int32_t val);
template GORGONZOLA_API void ValueVector::setValue<int16_t>(uint32_t pos, int16_t val);
template GORGONZOLA_API void ValueVector::setValue<int8_t>(uint32_t pos, int8_t val);
template GORGONZOLA_API void ValueVector::setValue<uint64_t>(uint32_t pos, uint64_t val);
template GORGONZOLA_API void ValueVector::setValue<uint32_t>(uint32_t pos, uint32_t val);
template GORGONZOLA_API void ValueVector::setValue<uint16_t>(uint32_t pos, uint16_t val);
template GORGONZOLA_API void ValueVector::setValue<uint8_t>(uint32_t pos, uint8_t val);
template GORGONZOLA_API void ValueVector::setValue<int128_t>(uint32_t pos, int128_t val);
template GORGONZOLA_API void ValueVector::setValue<uint128_t>(uint32_t pos, uint128_t val);
template GORGONZOLA_API void ValueVector::setValue<double>(uint32_t pos, double val);
...
void StringVector::addString(gorgonzola::common::ValueVector* vector, ku_string_t& dstStr,
