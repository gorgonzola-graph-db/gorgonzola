...
using gorgonzola::function::BuiltInFunctionsUtils;
...
bool UDTTypeInfo::operator==(const gorgonzola::common::ExtraTypeInfo& other) const {
...
const LogicalType& ListType::getChildType(const gorgonzola::common::LogicalType& type) {
...
const LogicalType& StructTypeInfo::getChildType(gorgonzola::common::struct_field_idx_t idx) const {
...
bool LogicalTypeUtils::isNested(gorgonzola::common::LogicalTypeID logicalTypeID) {
