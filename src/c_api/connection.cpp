...
gorgonzola_state gorgonzola_connection_init(gorgonzola_database* database,
    ...
    gorgonzola::c_api::HandleRegistry::getInstance().registerHandle(out_connection->_connection,
...
gorgonzola_state gorgonzola_connection_set_max_num_thread_for_exec(
...
gorgonzola_state gorgonzola_connection_get_max_num_thread_for_exec(
...
gorgonzola_state gorgonzola_connection_query(gorgonzola_connection* connection, const char* query,
    ...
    gorgonzola::c_api::HandleRegistry::getInstance().registerHandle(query_result,
        gorgonzola::c_api::HandleType::QueryResult);
...
gorgonzola_state gorgonzola_connection_prepare(gorgonzola_connection* connection, const char* query,
    ...
    gorgonzola::c_api::HandleRegistry::getInstance().registerHandle(prepared_statement,
        gorgonzola::c_api::HandleType::PreparedStatement);
...
gorgonzola_state gorgonzola_connection_set_query_timeout(gorgonzola_connection* connection,
