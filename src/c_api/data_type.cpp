...
void gorgonzola_data_type_create(gorgonzola_data_type_id id, gorgonzola_logical_type* child_type,
    ...
    gorgonzola::c_api::HandleRegistry::getInstance().registerHandle(data_type,
        gorgonzola::c_api::HandleType::LogicalType);
}
catch (...) {
...
void gorgonzola_data_type_clone(gorgonzola_logical_type* data_type,
...
bool gorgonzola_data_type_equals(gorgonzola_logical_type* data_type1,
