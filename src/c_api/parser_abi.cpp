...
static_assert((uint8_t)common::StatementType::STANDALONE_CALL_FUNCTION ==
              GORGONZOLA_STMT_STANDALONE_CALL_FUNCTION);
...
static_assert(
    (uint8_t)common::MatchClauseType::OPTIONAL_MATCH == GORGONZOLA_MATCH_CLAUSE_OPTIONAL_MATCH);
...
gorgonzola_statement gorgonzola_parsed_result_get_statement(gorgonzola_parsed_result result,
    uint64_t index) {
...
gorgonzola_single_query gorgonzola_query_get_single_query(gorgonzola_statement stmt,
    uint64_t index) {
...
gorgonzola_query_part gorgonzola_single_query_get_query_part(gorgonzola_single_query sq,
    uint64_t index) {
...
gorgonzola_reading_clause gorgonzola_single_query_get_reading_clause(gorgonzola_single_query sq,
    uint64_t index) {
...
gorgonzola_updating_clause gorgonzola_single_query_get_updating_clause(gorgonzola_single_query sq,
    uint64_t index) {
...
gorgonzola_reading_clause gorgonzola_query_part_get_reading_clause(gorgonzola_query_part qp,
    uint64_t index) {
    gorgonzola_reading_clause result = {nullptr};
    if (!qp._query_part) {
        return result;
...
gorgonzola_updating_clause gorgonzola_query_part_get_updating_clause(gorgonzola_query_part qp,
    uint64_t index) {
    gorgonzola_updating_clause result = {nullptr};
    if (!qp._query_part) {
        return result;
...
gorgonzola_expression gorgonzola_delete_clause_get_expression(gorgonzola_updating_clause uc,
    uint64_t index) {
    GORGONZOLA_C_API_BEGIN
...
gorgonzola_projection_body gorgonzola_return_clause_get_projection_body(
...
gorgonzola_expression gorgonzola_projection_body_get_expression(gorgonzola_projection_body pb,
    uint64_t index) {
    GORGONZOLA_C_API_BEGIN
...
gorgonzola_expression gorgonzola_projection_body_get_order_by(gorgonzola_projection_body pb,
    uint64_t index) {
    GORGONZOLA_C_API_BEGIN
