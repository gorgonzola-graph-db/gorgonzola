...
class GORGONZOLA_API PropertyExpression final : public Expression {
...
public:
    ...
    const std::string& getVariableName() const { return uniqueVarName; }
    const std::string& getRawVariableName() const { return rawVariableName; }
