...
LogicalType GORGONZOLA_API inferMinimalTypeFromString(const std::string& str);
LogicalType GORGONZOLA_API inferMinimalTypeFromString(std::string_view str);
...
void GORGONZOLA_API castStringToBool(const char* input, uint64_t len, bool& result);
...
GORGONZOLA_API inline void simpleIntegerCast(const char* input, uint64_t len, T& result,
