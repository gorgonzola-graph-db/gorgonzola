...
class GORGONZOLA_API SparseFrontier : public Frontier {
...
class GORGONZOLA_API DenseFrontier : public Frontier {
...
class GORGONZOLA_API FrontierPair {
public:
...
class GORGONZOLA_API DenseSparseDynamicFrontierPair : public FrontierPair {
public:
...
class GORGONZOLA_API DenseFrontierPair : public FrontierPair {
public:
