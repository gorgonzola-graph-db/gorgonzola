...
struct GORGONZOLA_API GDSConfig {
...
struct GORGONZOLA_API GDSBindData : public TableFuncBindData {
...
struct GORGONZOLA_API GDSFuncSharedState : public TableFuncSharedState {
...
class GORGONZOLA_API GDSFunction {
