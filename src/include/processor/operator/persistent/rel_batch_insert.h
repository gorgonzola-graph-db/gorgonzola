...
struct GORGONZOLA_API RelBatchInsertPrintInfo final : OPPrintInfo {
...
struct GORGONZOLA_API RelBatchInsertProgressSharedState {
...
struct GORGONZOLA_API RelBatchInsertInfo final : BatchInsertInfo {
...
struct GORGONZOLA_API RelBatchInsertLocalState final : BatchInsertLocalState {
    common::partition_idx_t nodeGroupIdx = common::INVALID_NODE_GROUP_IDX;
    std::unique_ptr<common::DataChunk> dummyAllNullDataChunk;
};

struct GORGONZOLA_API RelBatchInsertExecutionState {
 ...
 */
class GORGONZOLA_API RelBatchInsertImpl {
public:
...
class GORGONZOLA_API RelBatchInsert : public BatchInsert {
public:
