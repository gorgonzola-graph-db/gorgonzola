...
public:
    ColumnReader(ParquetReader& reader, common::LogicalType type,
        const gorgonzola_parquet::format::SchemaElement& schema, common::idx_t fileIdx,
...
protected:
    const gorgonzola_parquet::format::SchemaElement& schema;
    ...
    const gorgonzola_parquet::format::ColumnChunk* chunk = nullptr;
