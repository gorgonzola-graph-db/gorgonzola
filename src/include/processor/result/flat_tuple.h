...
public:
     ...
     */
    GORGONZOLA_API common::Value& operator[](common::idx_t idx);
     ...
     */
    GORGONZOLA_API const common::Value& operator[](common::idx_t idx) const;
     ...
     */
    GORGONZOLA_API std::string toString(const std::vector<uint32_t>& colsWidth,
