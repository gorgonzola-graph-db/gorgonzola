...
class GORGONZOLA_API ColumnChunkData {
public:
    ...
    static common::page_idx_t getNumPagesForBytes(uint64_t numBytes) {
        return (numBytes + common::GORGONZOLA_PAGE_SIZE - 1) / common::GORGONZOLA_PAGE_SIZE;
    }
...
class GORGONZOLA_API InternalIDChunkData final : public ColumnChunkData {
public:
