...
struct GORGONZOLA_API NodeTableScanState : TableScanState {
...
struct GORGONZOLA_API NodeTableDeleteState : TableDeleteState {
    common::ValueVector& nodeIDVector;
...
class GORGONZOLA_API NodeTable final : public Table {
public:
