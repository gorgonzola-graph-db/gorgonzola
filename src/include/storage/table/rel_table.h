...
struct GORGONZOLA_API RelTableInsertState : TableInsertState {
...
struct GORGONZOLA_API RelTableDeleteState final : TableDeleteState {
    common::ValueVector& srcNodeIDVector;
    common::ValueVector& dstNodeIDVector;
    common::ValueVector& relIDVector;
...
class GORGONZOLA_API RelTable final : public Table {
public:
