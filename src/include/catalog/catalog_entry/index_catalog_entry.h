...
struct GORGONZOLA_API IndexToCypherInfo : ToCypherInfo {
...
struct GORGONZOLA_API IndexAuxInfo {
...
class GORGONZOLA_API IndexCatalogEntry final : public CatalogEntry {
public:
