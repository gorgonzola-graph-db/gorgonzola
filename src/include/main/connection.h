...
public:
     ...
     */
    GORGONZOLA_API explicit Connection(Database* database);
    /**
     * @brief Destructs the connection.
     */
    GORGONZOLA_API ~Connection();
    /**
     ...
     */
    GORGONZOLA_API void setMaxNumThreadForExec(uint64_t numThreads);
    /**
     ...
     */
    GORGONZOLA_API uint64_t getMaxNumThreadForExec();
     ...
     */
    GORGONZOLA_API std::unique_ptr<PreparedStatement> prepare(std::string_view query);
     ...
     * @return the prepared statement.
     */
    GORGONZOLA_API std::unique_ptr<PreparedStatement> prepareWithParams(std::string_view query,
...
private:
    ...
    GORGONZOLA_API void addScalarFunction(std::string name, function::function_set definitions);
    GORGONZOLA_API void removeScalarFunction(std::string name);
