...
struct GORGONZOLA_API uint128_t {
    uint64_t low;
    uint64_t high;
...
GORGONZOLA_API uint128_t operator+(const uint128_t& lhs, const uint128_t& rhs);
GORGONZOLA_API uint128_t operator-(const uint128_t& lhs, const uint128_t& rhs);
GORGONZOLA_API uint128_t operator*(const uint128_t& lhs, const uint128_t& rhs);
GORGONZOLA_API uint128_t operator/(const uint128_t& lhs, const uint128_t& rhs);
GORGONZOLA_API uint128_t operator%(const uint128_t& lhs, const uint128_t& rhs);
GORGONZOLA_API uint128_t operator^(const uint128_t& lhs, const uint128_t& rhs);
GORGONZOLA_API uint128_t operator&(const uint128_t& lhs, const uint128_t& rhs);
GORGONZOLA_API uint128_t operator~(const uint128_t& val);
GORGONZOLA_API uint128_t operator|(const uint128_t& lhs, const uint128_t& rhs);
GORGONZOLA_API uint128_t operator<<(const uint128_t& lhs, int amount);
GORGONZOLA_API uint128_t operator>>(const uint128_t& lhs, int amount);

// comparison operators
GORGONZOLA_API bool operator==(const uint128_t& lhs, const uint128_t& rhs);
GORGONZOLA_API bool operator!=(const uint128_t& lhs, const uint128_t& rhs);
GORGONZOLA_API bool operator>(const uint128_t& lhs, const uint128_t& rhs);
GORGONZOLA_API bool operator>=(const uint128_t& lhs, const uint128_t& rhs);
GORGONZOLA_API bool operator<(const uint128_t& lhs, const uint128_t& rhs);
...
template<>
struct std::hash<gorgonzola::common::uint128_t> {
    std::size_t operator()(const gorgonzola::common::uint128_t& v) const noexcept;
};
