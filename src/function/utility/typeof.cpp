...
static std::unique_ptr<FunctionBindData> typeofBindFunc(const ScalarBindFuncInput& input) {
...
static void typeofExecFunc(const std::vector<std::shared_ptr<common::ValueVector>>&,
...
function_set TypeOfFunction::getFunctionSet() {
    ...
    auto function = std::make_unique<ScalarFunction>(name,
        std::vector<LogicalTypeID>{LogicalTypeID::ANY}, LogicalTypeID::STRING, typeofExecFunc);
    function->bindFunc = typeofBindFunc;
