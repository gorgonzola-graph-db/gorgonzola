...
static std::unique_ptr<FunctionBindData> mapcreationfunction_bindFunc(const ScalarBindFuncInput& input) {
...
function_set MapCreationFunctions::getFunctionSet() {
    ...
    auto function = std::make_unique<ScalarFunction>(name,
        std::vector<LogicalTypeID>{LogicalTypeID::LIST, LogicalTypeID::LIST}, LogicalTypeID::MAP, execFunc);
    function->bindFunc = mapcreationfunction_bindFunc;
