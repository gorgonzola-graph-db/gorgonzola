...
#include "function/gds/algo/component_ids.h"
#include "function/gds/algo/config/connected_components_config.h"
...
static std::unique_ptr<TableFuncBindData> stronglyconnectedcomponents_bindFunc(main::ClientContext* context,
...
function_set SCCFunction::getFunctionSet() {
    ...
    func->bindFunc = stronglyconnectedcomponents_bindFunc;
