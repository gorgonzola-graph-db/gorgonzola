...
static common::offset_t catalogversion_internalTableFunc(const TableFuncMorsel& /*morsel*/,
...
static std::unique_ptr<TableFuncBindData> catalogversion_bindFunc(const main::ClientContext*,
...
function_set CatalogVersionFunction::getFunctionSet() {
    ...
    function->tableFunc = SimpleTableFunc::getTableFunc(catalogversion_internalTableFunc);
    function->bindFunc = catalogversion_bindFunc;
